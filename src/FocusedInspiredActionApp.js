...
\f1 \uc0\u9989 
\f0  Daily F.I.A. calls\\n
\f1 \uc0\u9989 
\f0  Advanced AI coaching\\n
\f1 \uc0\u9989 
\f0  Priority support');\
    \} catch (error) \{\
                    ...
                    <div key=\{goal.id\} className="border border-gray-200 rounded-lg p-4">\
                      ...
                      <div className="flex items-center justify-between">\
                        ...
                        <span className="text-sm text-gray-500">\
                          \{goal.progress\}% \'95 Due: \{goal.deadline.toLocaleDateString()\}\
                        </span>\
                      </div>\
                    </div>\
                  ))\
                ...
                \{chatMessages.length === 0 && (\
                  <div className="text-center py-8">\
                    ...
                    <div className="mt-3 space-y-1 text-xs text-gray-400">\
                      <p>\'95 "How do I stay focused?"</p>\
                      <p>\'95 "Help me prioritize my tasks"</p>\
                      <p>\'95 "I'm feeling overwhelmed"</p>\
                    </div>\
                  </div>\
                )\}\
...
\f1 \uc0\u55357 \u56542 
\f0  Book 1-Hour Coaching Call ($197)\
                </button>\
                \
                <button\
                  onClick=\{() => \{\
